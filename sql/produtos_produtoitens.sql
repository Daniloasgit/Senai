...
--
-- Table structure for table `produtoitens`
--

DROP TABLE IF EXISTS `produtoitens`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `produtoitens` (
...
--
-- Dumping data for table `produtoitens`
--

LOCK TABLES `produtoitens` WRITE;
/*!40000 ALTER TABLE `produtoitens` DISABLE KEYS */;
/*!40000 ALTER TABLE `produtoitens` ENABLE KEYS */;
UNLOCK TABLES;
